...
void Initialize() {
	...
	g_Globals->Menufont2 = I::Surface->FontCreate();
	...
	I::Surface->SetFontGlyphSet(g_Globals->Namefont, "Impact", 35, 550, 0, 0, FONTFLAG_DROPSHADOW | FONTFLAG_OUTLINE | FONTFLAG_ANTIALIAS);
}
